...
import nl.onnoh.bdg.bpmn.TArtifact;
import nl.onnoh.bdg.bpmn.TAssociation;
import nl.onnoh.bdg.bpmn.TCategory;
import nl.onnoh.bdg.bpmn.TCollaboration;
import nl.onnoh.bdg.bpmn.TError;
import nl.onnoh.bdg.bpmn.TEscalation;
import nl.onnoh.bdg.bpmn.TGroup;
import nl.onnoh.bdg.bpmn.TMessage;
import nl.onnoh.bdg.bpmn.TProcess;
import nl.onnoh.bdg.bpmn.TRootElement;
import nl.onnoh.bdg.bpmn.TSignal;
import nl.onnoh.bdg.bpmn.TTextAnnotation;
...
import nl.onnoh.bdg.bpmn.model.definitions.collaboration.Artifact;
import nl.onnoh.bdg.bpmn.model.definitions.collaboration.Participant;
import nl.onnoh.bdg.bpmn.model.definitions.process.Lane;
import nl.onnoh.bdg.bpmn.model.definitions.process.LaneSet;
...
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ATTRIBUTE_TARGET_REF;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_ASSOCIATION;
...
public class DefinitionsParser {
    ...
    public static List<Participant> parseParticipants(List<nl.onnoh.bdg.bpmn.Participant> participants) {
        log.debug("Parsing {} participants.", participants.size());
        List<Participant> parsedParticipants = new ArrayList<>();
        for (nl.onnoh.bdg.bpmn.Participant participant : participants) {
    ...
    private static List<LaneSet> parseLaneSets(List<nl.onnoh.bdg.bpmn.LaneSet> laneSets) {
    ...
    private static List<Lane> parseLanes(List<nl.onnoh.bdg.bpmn.Lane> lanes) {
