...
import nl.onnoh.bdg.bpmn.TSequenceFlow;
import nl.onnoh.bdg.bpmn.model.other.SequenceFlow;

import java.util.ArrayList;
import java.util.List;

import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_AD_HOC_SUB_PROCESS;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_BOUNDARY_EVENT;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_BUSINESS_RULE_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_CALL_ACTIVITY;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_COMPLEX_GATEWAY;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_DATA_OBJECT;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_DATA_OBJECT_REFERENCE;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_DATA_STORE_REFERENCE;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_END_EVENT;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_EVENT_BASED_GATEWAY;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_EXCLUSIVE_GATEWAY;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_INCLUSIVE_GATEWAY;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_INTERMEDIATE_CATCH_EVENT;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_INTERMEDIATE_THROW_EVENT;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_MANUAL_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_PARALLEL_GATEWAY;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_RECEIVE_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_SCRIPT_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_SEND_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_SEQUENCE_FLOW;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_SERVICE_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_START_EVENT;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_SUB_PROCESS;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_TASK;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_TRANSACTION;
import static nl.onnoh.bdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_USER_TASK;
import static nl.onnoh.bdg.bpmn.parser.EventParser.parseBoundaryEvent;
import static nl.onnoh.bdg.bpmn.parser.EventParser.parseEndEvent;
import static nl.onnoh.bdg.bpmn.parser.EventParser.parseIntermediateCatchEvent;
import static nl.onnoh.bdg.bpmn.parser.EventParser.parseIntermediateThrowEvent;
import static nl.onnoh.bdg.bpmn.parser.EventParser.parseStartEvent;
import static nl.onnoh.bdg.bpmn.parser.GatewayParser.parseComplexGateway;
import static nl.onnoh.bdg.bpmn.parser.GatewayParser.parseEventBasedGateway;
import static nl.onnoh.bdg.bpmn.parser.GatewayParser.parseExclusiveGateway;
import static nl.onnoh.bdg.bpmn.parser.GatewayParser.parseInclusiveGateway;
import static nl.onnoh.bdg.bpmn.parser.GatewayParser.parseParallelGateway;
import static nl.onnoh.bdg.bpmn.parser.OtherParser.parseDataObject;
import static nl.onnoh.bdg.bpmn.parser.OtherParser.parseDataObjectReference;
import static nl.onnoh.bdg.bpmn.parser.OtherParser.parseDataStoreReference;
import static nl.onnoh.bdg.bpmn.parser.OtherParser.parseTransaction;
import static nl.onnoh.bdg.bpmn.parser.SubprocessParser.parseAdHocSubProcess;
import static nl.onnoh.bdg.bpmn.parser.SubprocessParser.parseCallActivity;
import static nl.onnoh.bdg.bpmn.parser.SubprocessParser.parseSubProcess;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseAnonymousTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseBusinessRuleTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseManualTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseReceiveTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseScriptTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseSendTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseServiceTask;
import static nl.onnoh.bdg.bpmn.parser.TaskParser.parseUserTask;
