...
public final class BpmnModelConstants {
    ...
    public static final String BPMN_ELEMENT_MESSAGE_BOUNDARY_EVENT = "messageBoundaryEvent";
    public static final String BPMN_ELEMENT_TIMER_BOUNDARY_EVENT = "timerBoundaryEvent";
    public static final String BPMN_ELEMENT_CONDITIONAL_BOUNDARY_EVENT = "conditionalBoundaryEvent";
    public static final String BPMN_ELEMENT_ESCALATION_BOUNDARY_EVENT = "escalationBoundaryEvent";
    public static final String BPMN_ELEMENT_COMPENSATE_BOUNDARY_EVENT = "compensateBoundaryEvent";
    public static final String BPMN_ELEMENT_SIGNAL_BOUNDARY_EVENT = "signalBoundaryEvent";
    public static final String BPMN_ELEMENT_ERROR_BOUNDARY_EVENT = "errorBoundaryEvent";
}