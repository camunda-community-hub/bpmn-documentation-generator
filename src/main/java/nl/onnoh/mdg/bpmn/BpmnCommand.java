...
import nl.onnoh.mdg.bpmn.model.BpmnDocumentation;
...
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_COLLABORATION;
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_ERROR;
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_ESCALATION;
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_MESSAGE;
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_PROCESS;
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_ELEMENT_SIGNAL;
import static nl.onnoh.mdg.bpmn.BpmnModelConstants.BPMN_TARGET_NS;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseCategory;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseCollaboration;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseError;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseEscalation;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseMessage;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseProcess;
import static nl.onnoh.mdg.bpmn.parser.DefinitionsParser.parseSignal;
...
public class BpmnCommand implements Callable {
    ...
    private static BpmnDocumentation buildTemplateVariables(String bpmnFile) {
        ...
        log.info("Parsing BPMN file: {}", bpmnFile);
